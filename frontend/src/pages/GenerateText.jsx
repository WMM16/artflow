...
import { Card, Form, Input, Button, Select, Slider, Row, Col, Space, Typography, message, Image, Spin, Tag, Tooltip, Modal } from 'antd'
import {
  ThunderboltOutlined,
  DownloadOutlined,
  ReloadOutlined,
...
function GenerateText() {
  ...
  const handleGenerate = async (values) => {
    ...
    try {
      ...
      const response = await generateApi.generateFromText({
        prompt: values.prompt,
        negative_prompt: values.negativePrompt || undefined,
        width,
        height,
        image_count: values.count
      })
